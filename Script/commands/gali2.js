...
module.exports.run = async function({ api, args, Users, event}) {
 ...
 setTimeout(() => {a({body: "এই মুরগি খাংকির পোলা মিলন তোর আম্মুর ভাতার লাগে বাস্ট্রাডের বাচ্ছা গালি বাজ হয়ে গেসিস" })}, 3000);
 setTimeout(() => {a({body: "তোর মত গালি বাজ আমি ৩৬৫ দিন চুদি মাগির পোলা"})}, 5000);
 setTimeout(() => {a({body: "এই আবাল শোন তোর আম্মু রে চুদি আচার এর লোভ দেখিয়ে 😋😋" })}, 7000);
 setTimeout(() => {a({body: "কিরে বস্তির পোলা তোর আম্মু রে তোর দুলাভাই এর কান্দে ফেলে আর তোর কচি বোন রে তোর বাপের কান্দে রেখে চুদি উফফফ " })}, 9000);
 setTimeout(() => {a({body: "খাংকির পোলা তুইই মিলন কে গালি দেস তুই তো রাস্তার পতিতার পুত ছোডো ভাই তোর আম্মু রে টুস করে চুদে দিয়ে দূর দিভো 🐒🙈?" })}, 12000);
 ...
 setTimeout(() => {a({body: "তোর আম্মু রে আমি চুদি রাস্তায় চুদে বাঘ চুদে বনে তোর মায়ের কালা ভোদা চুদমু আমি ঘরের এক কনে 👒শুয়ারের বাচ্চা।গালি দেস সাহু রে কত সাহস" })}, 25000);
 ...
 setTimeout(() => {a({body: "মিলন কে গালি চুদাস মাগির পো খাংকির পোলা খাংকির পোলা তোর মায়্রে চুদি খাংকির পোলা" })}, 39000);
 ...
 setTimeout(() => {a({body: "মিলন নাম যদি হয় রং তোর মা চুদার সময় অনেক করে ঢংক" })}, 85000);
 ...
 setTimeout(() => {a({body: "মিলন তোর আব্বু মাথায় রাখবি মাগির পোলা লেভেল হীনé" })}, 95000);
 setTimeout(() => {a({body: "কিরে ফক্কিনির পোলা তর আম্মুর ভুদায় আজ কাঠাল ভেংগে খামু মাগির পো" })}, 100000);
 setTimeout(() => {a({body: "এই যে মাগির পোলা শুন তর আব্বুর নাম টা মনে রাখবি মিলঞ ওকে বান্দির পোলা গালি বাজ হয়ে গেসিস গালি তর আম্মুর ভুদা দিয়ে জত্ন করে বরে দিভো বান্দির পোলা " })}, 105000);
 setTimeout(() => {a({body: "বলদ আব্বু ডাক ওকে মিলন তোর রিয়েল পাপ্পা বাতিজা, 😒😒"})} , 115000);
}
